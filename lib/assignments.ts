...
export const ASSIGNMENTS: AssignmentMeta[] = [
  ...
  },
  {
    ...
    kind: "assignment",
    topic: "bigo",
    summary: "Reason about Big O time and space complexity.",
  },
  {
    id: "assignment4",
  ...
  {
    id: "assignment9",
    title: "Assignment 9 — Final Project Prototype",
    kind: "assignment",
    topic: "advanced",
    summary: "Prototype an advanced data structure of your choice.",
  },
  {
    id: "review3",
